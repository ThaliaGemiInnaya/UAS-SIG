...
<body>
    ...
    <div id="sidebar" class="tm-sidebar-left uk-background-default">
        <center>
            <div class="user">
                <img id="avatar" width="100" class="uk-border-circle" src="<?= base_url('public/') ?>images/ikon.png" />
        ...
        <ul class="uk-nav uk-nav-default">
            ...
            <li <?php if ($menu == "pertanian") {
                ?> class="uk-active" <?php
                                    } ?>><a href="<?= base_url('administrator/pertanian') ?>"><span data-uk-icon="icon:  world" class="uk-margin-small-right"></span>PETA PEMETAAN</a></li>
